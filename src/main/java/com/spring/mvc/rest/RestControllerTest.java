...
public class RestControllerTest {
    ...
    // 자바스크립트에서 POST방식으로 서버에 요청하면서
    // 데이터를 보냄, JSON형식으로 구성된 데이터 name, age, hobby를 받을 거임
    // 객체를 디자인해야함(Person 클래스)
    ...
    @PostMapping("/object")
    @ResponseBody // 메서드가 리턴하는 데이터(object(@RequestBody Person p))를
    // viewResolver에게 전달하지 않고,
