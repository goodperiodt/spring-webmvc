...
class BoardRepositoryImTest {
    ...
    void bulkInsert() {
        // given
        // 반복문을 이용하여 저장하는데, 작성자, 제목, 내용에 제어변수 값을 붙여서 INSERT하기
        // test1, test2 ...
        for (int i = 1; i <= 300; i++) {
    ...
    void findAllTest() {
         ...
         */
        // then
        Assertions.assertEquals(300, boardList.size());
    }
    
    @Test
    @DisplayName("30번 게시물을 단일 조회하면 제목에 30이 포함되어 있어야 한다.") // Assertion
    void findOneTest() {
        // given
        int boardNo = 30;
